        ...
        <div class="container container-estreito">
            <div class="faq-grupo reveal-page">
                ...
                <details class="faq-item">
                    <summary data-i18n="shopQ1">Quando abre a loja?</summary>
                    <p data-i18n="shopA1">A coleção ainda não está disponível. Novidades em breve.</p>
                </details>
                <details class="faq-item">
                    <summary data-i18n="shopQ2">Posso encomendar agora?</summary>
                    <p data-i18n="shopA2">Não. Produtos, carrinho e checkout estão fechados até a loja abrir.</p>
                </details>
                <details class="faq-item">
                    <summary data-i18n="shopQ3">Como fico a saber quando abrir?</summary>
                    <p data-i18n="shopA3">Volta a esta página ou contacta-nos. Quando a coleção estiver pronta, aparece aqui.</p>
                </details>
            </div>
            ...
            <div class="faq-grupo reveal-page">
                ...
                <details class="faq-item">
                    ...
                    <p data-i18n="partA1">Contacta directamente por e-mail, WhatsApp ou redes sociais para uma proposta personalizada.</p>
                </details>
                <details class="faq-item">
                    <summary data-i18n="partQ2">Fornecem media kit?</summary>
                    <p data-i18n="partA2">Sim. Pede material de imprensa por e-mail ou WhatsApp: bio, estatísticas e recursos oficiais.</p>
                </details>
                <details class="faq-item">
            ...
            <div class="faq-grupo reveal-page">
                ...
                <details class="faq-item">
                    <summary data-i18n="accQ4">Preciso de conta para contactar?</summary>
                    <p data-i18n="accA4">Não. Podes contactar o atleta por e-mail, WhatsApp ou redes sociais, sem criar conta. A conta só é necessária para encomendas e para a área de mensagens no site.</p>
                </details>
                <details class="faq-item">
            ...
            <div class="cta-box reveal-page">
                ...
                <p data-i18n="ctaText">A equipa Lone Wolf responde por e-mail, WhatsApp ou redes sociais.</p>
...
<script>window.pageTranslations = {
    pt: {
        ...
        shopTitle: "Loja",
        shopQ1: "Quando abre a loja?",
        shopA1: "A coleção ainda não está disponível. Novidades em breve.",
        shopQ2: "Posso encomendar agora?",
        shopA2: "Não. Produtos, carrinho e checkout estão fechados até a loja abrir.",
        shopQ3: "Como fico a saber quando abrir?",
        shopA3: "Volta a esta página ou contacta-nos. Quando a coleção estiver pronta, aparece aqui.",
        ...
        partA1: "Contacta directamente por e-mail, WhatsApp ou redes sociais para uma proposta personalizada.",
        partQ2: "Fornecem media kit?",
        partA2: "Sim. Pede material de imprensa por e-mail ou WhatsApp: bio, estatísticas e recursos oficiais.",
        ...
        accQ4: "Preciso de conta para contactar?",
        accA4: "Não. Podes contactar o atleta por e-mail, WhatsApp ou redes sociais, sem criar conta. A conta só é necessária para encomendas e para a área de mensagens no site.",
        ...
        ctaText: "A equipa Lone Wolf responde por e-mail, WhatsApp ou redes sociais.",
        ctaBtn: "Contactar"
    },
    en: {
        pageTitle: "FAQ | Lone Wolf",
        ...
        shopTitle: "Shop",
        shopQ1: "When does the shop open?",
        shopA1: "The collection is not available yet. Coming soon.",
        shopQ2: "Can I order now?",
        shopA2: "No. Products, cart and checkout stay closed until the shop opens.",
        shopQ3: "How do I know when it opens?",
        shopA3: "Come back to this page or contact us. When the collection is ready, it will be here.",
        ...
        partA1: "Contact us directly by email, WhatsApp or social media for a tailored proposal.",
        partQ2: "Do you provide a media kit?",
        partA2: "Yes. Request press material by email or WhatsApp: bio, statistics and official resources.",
        ...
        accQ4: "Do I need an account to get in touch?",
        accA4: "No. You can contact the athlete by email, WhatsApp or social media, without creating an account. An account is only needed for orders and the on-site messaging area.",
        ...
        ctaText: "The Lone Wolf team replies by email, WhatsApp or social media.",
        ctaBtn: "Contact"
    }
};</script>
