<?php
if (defined("LW_HEADER_LOADED")) {
    return;
}
define("LW_HEADER_LOADED", true);
...
if ($nomeUser !== "") {
    $inicial = trim($nomeUser);
    $inicialUser = function_exists("mb_substr")
        ? mb_strtoupper(mb_substr($inicial, 0, 1))
        : strtoupper(substr($inicial, 0, 1));
} else {
    $inicialUser = "";
}
