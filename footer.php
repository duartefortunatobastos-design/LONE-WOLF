        ...
        <div class="footer-top">
            <div class="footer-brand">
                ...
                <p class="footer-text" data-footer-i18n="footerText">
                    A ultrapassar os limites do desempenho humano. Cada quilómetro é um passo mais perto da excelência.
                </p>
            </div>
...
document.addEventListener("DOMContentLoaded", () => {
    if (typeof initChatNotifications === "function") {
        initChatNotifications({
            isAdmin: <?= (isset($_SESSION["tipo"]) && $_SESSION["tipo"] === "admin") ? "true" : "false" ?>,
            badgeId: "chat-notify-badge",
            chatLink: <?= (isset($_SESSION["tipo"]) && $_SESSION["tipo"] === "admin") ? '"admin_mensagens.php"' : '"minhas_mensagens.php"' ?>
        });
    }
});
</script>
