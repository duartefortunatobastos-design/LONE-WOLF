...
<div class="grid">
    ...
    <div class="card reveal-page">
        ...
        <div class="card-content">
            ...
            <p data-i18n="predialText">
                A Predial Piedense é uma empresa imobiliária com décadas de experiência.
            </p>
    ...
    <div class="card reveal-page">
        ...
        <div class="card-content">
            ...
            <p data-i18n="filipeText">
                Empresa de transporte rodoviário reconhecida pela eficiência e qualidade.
            </p>
    ...
    <div class="card reveal-page">
        ...
        <div class="card-content">
            <h3>LH Ginásio</h3>
            <p data-i18n="lhText">
                Espaço de treino focado na melhoria da condição física e bem-estar.
            </p>
    ...
    <div class="card reveal-page">
        ...
        <div class="card-content">
            ...
            <p data-i18n="imperatrizText">
                Restaurante tradicional conhecido pelos grelhados no carvão.
            </p>
...
<script>window.pageTranslations = {
    pt: {
        ...
        predialText: "A Predial Piedense é uma empresa imobiliária com décadas de experiência.",
        filipeText: "Empresa de transporte rodoviário reconhecida pela eficiência e qualidade.",
        lhText: "Espaço de treino focado na melhoria da condição física e bem-estar.",
        imperatrizText: "Restaurante tradicional conhecido pelos grelhados no carvão.",
    ...
    en: {
        ...
        predialText: "Predial Piedense is a real estate company with decades of experience.",
        filipeText: "A road transport company known for efficiency and quality.",
        lhText: "A training space focused on improving physical condition and well-being.",
        imperatrizText: "A traditional restaurant known for its charcoal-grilled dishes.",
